...
<library name="s3-pilot2-lbr">
<packages>
<package name="MPU-6050-BO">
<pad name="VCC" x="1.27" y="19.05" drill="0.8" shape="square"/>
<pad name="GND" x="1.27" y="16.51" drill="0.8"/>
<pad name="SCL" x="1.27" y="13.97" drill="0.8"/>
<pad name="SDA" x="1.27" y="11.43" drill="0.8"/>
<pad name="XDA" x="1.27" y="8.89" drill="0.8"/>
<pad name="XCL" x="1.27" y="6.35" drill="0.8"/>
<pad name="AD0" x="1.27" y="3.81" drill="0.8"/>
<pad name="INT" x="1.27" y="1.27" drill="0.8"/>
<wire x1="0" y1="20.32" x2="11.43" y2="20.32" width="0.127" layer="21"/>
<wire x1="11.43" y1="20.32" x2="11.43" y2="0" width="0.127" layer="21"/>
<wire x1="11.43" y1="0" x2="0" y2="0" width="0.127" layer="21"/>
<wire x1="0" y1="0" x2="0" y2="20.32" width="0.127" layer="21"/>
</package>
<package name="MC33926-SINGLE-BO">
<wire x1="-6.35" y1="-22.86" x2="19.05" y2="-22.86" width="0.127" layer="48"/>
<wire x1="19.05" y1="-22.86" x2="19.05" y2="7.62" width="0.127" layer="48"/>
<wire x1="-6.35" y1="7.62" x2="-6.35" y2="-22.86" width="0.127" layer="48"/>
<pad name="VIN" x="-5.08" y="6.35" drill="0.8"/>
<pad name="GND" x="-5.08" y="3.81" drill="0.8" shape="square"/>
<pad name="VDD" x="-5.08" y="1.27" drill="0.8"/>
<pad name="IN2" x="-5.08" y="-1.27" drill="0.8"/>
<pad name="IN1" x="-5.08" y="-3.81" drill="0.8"/>
<pad name="PWM_!D2" x="-5.08" y="-6.35" drill="0.8"/>
<pad name="!PWM!_D1" x="-5.08" y="-8.89" drill="0.8"/>
<pad name="!SF" x="-5.08" y="-11.43" drill="0.8"/>
<pad name="FB" x="-5.08" y="-13.97" drill="0.8"/>
<pad name="EN" x="-5.08" y="-16.51" drill="0.8"/>
<pad name="SLEW" x="-5.08" y="-19.05" drill="0.8"/>
<pad name="INV" x="-5.08" y="-21.59" drill="0.8"/>
<wire x1="-6.35" y1="7.62" x2="19.05" y2="7.62" width="0.127" layer="48"/>
</package>
</packages>
<symbols>
<symbol name="MPU-6050-BO">
...
<pin name="AD0" x="-15.24" y="-5.08" length="middle" direction="in"/>
...
<symbol name="MC33926-SINGLE-BO">
<pin name="VIN" x="-15.24" y="15.24" length="middle" direction="nc"/>
...
<pin name="PWM_!D2" x="-15.24" y="2.54" length="middle" direction="in"/>
<pin name="!PWM!_D1" x="-15.24" y="0" length="middle" direction="in"/>
<pin name="!SF" x="-15.24" y="-2.54" length="middle" direction="out"/>
<pin name="FB" x="-15.24" y="-5.08" length="middle" direction="out"/>
<pin name="EN" x="-15.24" y="-7.62" length="middle" direction="in"/>
<pin name="SLEW" x="-15.24" y="-10.16" length="middle" direction="in"/>
<pin name="INV" x="-15.24" y="-12.7" length="middle" direction="in"/>
...
<devicesets>
<deviceset name="MPU-6050-BO">
<gates>
<gate name="G$1" symbol="MPU-6050-BO" x="27.94" y="-2.54"/>
</gates>
<devices>
<device name="" package="MPU-6050-BO">
<connects>
...
<deviceset name="MC33926-SINGLE-BO">
<gates>
<gate name="G$1" symbol="MC33926-SINGLE-BO" x="-15.24" y="-15.24"/>
</gates>
<devices>
<device name="" package="MC33926-SINGLE-BO">
<connects>
<connect gate="G$1" pin="!PWM!_D1" pad="!PWM!_D1"/>
...
<connect gate="G$1" pin="PWM_!D2" pad="PWM_!D2"/>
...
<parts>
<part name="GND" library="SparkFun-Boards" deviceset="ARDUINO_R3_SHIELD" device=""/>
<part name="MPU6050" library="s3-pilot2-lbr" deviceset="MPU-6050-BO" device=""/>
<part name="HEARTBEAT" library="SparkFun-LED" deviceset="LED-BLUE" device="1206" value="BLUE"/>
...
<part name="ENABLE" library="SparkFun-LED" deviceset="LED-RED" device="1206" value="RED"/>
...
<part name="M2_1" library="pinhead" deviceset="PINHD-1X2" device="" value="ENA"/>
<part name="GND1" library="SparkFun-Aesthetics" deviceset="GND" device=""/>
<part name="SUPPLY1" library="SparkFun-Aesthetics" deviceset="VDD" device=""/>
<part name="U$1" library="s3-pilot2-lbr" deviceset="MC33926-SINGLE-BO" device="" value="M1"/>
<part name="U$3" library="s3-pilot2-lbr" deviceset="MC33926-SINGLE-BO" device="" value="M2"/>
...
<part name="JP4" library="pinhead" deviceset="PINHD-1X4" device="/90" value="M2_ENC"/>
...
<instance part="MPU6050" gate="G$1" x="144.78" y="45.72" rot="R180"/>
<instance part="HEARTBEAT" gate="G$1" x="182.88" y="134.62"/>
<instance part="R6" gate="G$1" x="182.88" y="124.46" rot="R90"/>
<instance part="POWER" gate="G$1" x="195.58" y="134.62"/>
<instance part="ENABLE" gate="G$1" x="208.28" y="134.62"/>
<instance part="R4" gate="G$1" x="195.58" y="124.46" rot="R90"/>
<instance part="R8" gate="G$1" x="208.28" y="124.46" rot="R90"/>
<instance part="M2_1" gate="G$1" x="139.7" y="114.3" rot="R180"/>
<instance part="GND1" gate="1" x="220.98" y="111.76"/>
<instance part="SUPPLY1" gate="VDD" x="243.84" y="30.48" rot="R180"/>
<instance part="U$1" gate="G$1" x="91.44" y="104.14"/>
<instance part="U$3" gate="G$1" x="91.44" y="55.88"/>
<instance part="GND2" gate="1" x="241.3" y="88.9" rot="R180"/>
<instance part="SUPPLY6" gate="VDD" x="71.12" y="114.3" rot="R90"/>
...
<instance part="JP4" gate="A" x="142.24" y="73.66" rot="R180"/>
...
<wire x1="167.64" y1="43.18" x2="167.64" y2="83.82" width="0.1524" layer="91"/>
...
<pinref part="GND" gate="G$1" pin="GND@2"/>
...
<pinref part="GND" gate="G$1" pin="GND@0"/>
...
<pinref part="GND" gate="G$1" pin="GND@1"/>
...
<pinref part="U$1" gate="G$1" pin="!PWM!_D1"/>
...
<pinref part="U$3" gate="G$1" pin="!PWM!_D1"/>
...
<pinref part="GND" gate="G$1" pin="5V"/>
...
<segment>
<pinref part="GND" gate="G$1" pin="*D3"/>
...
<net name="ESC_EN_JMP" class="0">
<segment>
<pinref part="GND" gate="G$1" pin="D12"/>
<wire x1="198.12" y1="78.74" x2="182.88" y2="78.74" width="0.1524" layer="91"/>
<label x="176.276" y="78.74" size="1.778" layer="95"/>
</segment>
<segment>
<pinref part="M2_1" gate="G$1" pin="2"/>
...
<segment>
<pinref part="GND" gate="G$1" pin="RES"/>
...
<segment>
<pinref part="M2_1" gate="G$1" pin="1"/>
<wire x1="142.24" y1="111.76" x2="152.4" y2="111.76" width="0.1524" layer="91"/>
<label x="162.56" y="111.76" size="1.778" layer="95" rot="R180"/>
</segment>
<segment>
...
<segment>
<pinref part="GND" gate="G$1" pin="A5"/>
...
<approved hash="115,1,165.1,40.64,SCL,,,,,"/>
<approved hash="115,1,167.64,63.5,SDA,,,,,"/>
</errors>
</schematic>
</drawing>
</eagle>
